					...
					<div class="lg:col-span-1">
						...
						<div class="flex items-center space-x-4 mt-12">
							...
							if ( get_field( 'employee_facebook' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_facebook' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_twitter' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_twitter' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_linkedin' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_linkedin' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
