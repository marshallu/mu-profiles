					...
					<div class="lg:col-span-1">
						...
						<div class="mt-6 mb-8">
							...
							if ( get_field( 'employee_position' ) ) {
								?>
								<div class="my-2 text-lg font-semibold"><?php echo esc_attr( get_field( 'employee_position' ) ); ?></div>
							<?php } ?>
						...
						if ( get_field( 'employee_office_location' ) ) {
							?>
								<div class="flex items-start my-4">
									...
									<?php echo esc_attr( get_field( 'employee_office_location' ) ); ?>
								</div>
						<?php } ?>
						...
						if ( get_field( 'employee_email_address' ) && ( 'both' === get_field( 'profile_show_email_address', 'option' ) || 'both' === get_field( 'profile_show_email_address', 'profile' ) ) ) {
							?>
								<div class="flex items-center my-4">
									...
									<a href="mailto:<?php echo esc_attr( get_field( 'employee_email_address' ) ); ?>"><?php echo esc_attr( get_field( 'employee_email_address' ) ); ?></a>
						...
						if ( get_field( 'employee_website' ) ) {
							...
							<div class="flex items-center my-4">
								...
								<a href="<?php echo esc_attr( get_field( 'employee_website' ) ); ?>">Visit Website</a>
							</div>
						<?php } ?>
						...
						<div class="flex items-center space-x-4 mt-12">
							...
							if ( get_field( 'employee_facebook' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_facebook' ) ); ?>" class="py-2 px-2 text-white bg-green rounded-sm hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_twitter' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_twitter' ) ); ?>" class="py-2 px-2 text-white bg-green rounded-sm hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_linkedin' ) ) {
								?>
								<a href="<?php echo esc_attr( get_field( 'employee_linkedin' ) ); ?>" class="py-2 px-2 text-white bg-green rounded-sm hover:bg-green-dark hover:text-white">
					...
					<div class="lg:col-span-3">
						...
						if ( get_field( 'employee_college_service' ) ) {
							...
							foreach ( get_field( 'employee_college_service' ) as $row ) {
								...
								$profile_toggle_content .= '<svg class="mr-4 h-6 w-6 fill-green mt-1 lg:mt-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/></svg>';
								$profile_toggle_content .= '<span class="flex-1">';
								if ( ! empty( $row['service_information'] ) ) {
									$profile_toggle_content .= wp_kses_post( $row['service_information'] );
								} else {
