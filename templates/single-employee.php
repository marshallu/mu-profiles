					...
					<div class="lg:col-span-1">
						...
						<div class="mt-6 mb-8">
							...
							if ( get_field( 'employee_position' ) ) {
								?>
								<div class="my-2 text-lg font-semibold"><?php esc_attr( get_field( 'employee_position' ) ); ?></div>
							<?php } ?>
						...
						if ( get_field( 'employee_office_location' ) ) {
							?>
								<div class="flex items-start my-4">
									...
									<?php esc_attr( get_field( 'employee_office_location' ) ); ?>
								</div>
						<?php } ?>
						...
						if ( get_field( 'employee_email_address' ) && ( 'both' === get_field( 'profile_show_email_address', 'option' ) || 'both' === get_field( 'profile_show_email_address', 'profile' ) ) ) {
							?>
								<div class="flex items-center my-4">
									...
									<a href="mailto:<?php esc_attr( get_field( 'employee_email_address' ) ); ?>"><?php esc_attr( get_field( 'employee_email_address' ) ); ?></a>
						...
						if ( get_field( 'employee_website' ) ) {
							...
							<div class="flex items-center my-4">
								...
								<a href="<?php esc_attr( get_field( 'employee_website' ) ); ?>">Visit Website</a>
							</div>
						<?php } ?>
						...
						<div class="flex items-center space-x-4 mt-12">
							...
							if ( get_field( 'employee_facebook' ) ) {
								?>
								<a href="<?php esc_attr( get_field( 'employee_facebook' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_twitter' ) ) {
								?>
								<a href="<?php esc_attr( get_field( 'employee_twitter' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
							...
							if ( get_field( 'employee_linkedin' ) ) {
								?>
								<a href="<?php esc_attr( get_field( 'employee_linkedin' ) ); ?>" class="py-2 px-2 text-white bg-green rounded hover:bg-green-dark hover:text-white">
